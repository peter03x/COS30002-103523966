...
class Agent(object):
	...
	def __init__(self, world=None, scale=30.0, mass=1.0, mode='seek'):
		...
		self.waypoint_threshold = 9.0  # <-- Work out a value for this as you test!
	...
	def randomise_path(self):
		...
		self.path.create_random_path(num_pts, margin, margin, cx - margin, cy - margin, looped)  # you have to figure out the parameters
